...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Kunjungan Poli Gigi</h3>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Kunjungan Poli Gigi</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('kunjungan.poli-gigi.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="jasa">Jasa Tindakan</label>
                                        <input type="text" name="jasa" class="form-control" value="{{ old('jasa') }}" required>
                                    </div>
                                    <div class="form-group">
